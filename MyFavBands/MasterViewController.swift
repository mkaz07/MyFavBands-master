...
//********3) Add next two lines for array and title
        listArray = ["Aphex Twin", "Herbie Hancock", "JPEGMAFIA", "Little Simz", "Orion Sun", "Radiohead ", "Stevie Wonder", "Still Woozy", "Tom Misch", "Tyler the Creator"]
            
            //["Air Supply", "Joe Cocker","Leonard Skynard","Eagles","Journey", "38 Special","Miranda Lambert", "Little Big Town","Band Perry"]
